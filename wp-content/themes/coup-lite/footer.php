...
?>
	...
	<footer id="colophon" class="site-footer" role="contentinfo">
		...
		<div class="site-info">
			<a class="site-info-link-wp" href="<?php echo 'https://wordpress.org/'; ?>" style="color: white;">
				<?php echo esc_html__('Proudly powered by WordPress', 'coup'); ?>
			</a>
		</div>
		<div class="site-info">
			<span class="sep"><?php echo esc_html__(' - ', 'coup'); ?></span>
			<a class="site-info-theme" href="<?php echo 'https://themeskingdom.com/'; ?>" target="_blank">
